...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "亘丨孬",
		Reset: "廿賱睾丕亍",
		odata : ['賷爻丕賵賷', '賷禺鬲賱賮', '兀賯賱', '兀賯賱 兀賵 賷爻丕賵賷','兀賰亘乇','兀賰亘乇 兀賵 賷爻丕賵賷', '賷亘丿兀 亘赌','賱丕 賷亘丿兀 亘赌','est dans',"n'est pas dans",'賷賳鬲赖 亘赌','賱丕 賷賳鬲赖 亘赌','賷丨鬲賵賷','賱丕 賷丨鬲賵賷'],
	...
	edit : {
		...
		bCancel: "廿賱睾丕亍",
		bClose: "睾賱賯",
		saveData: "鬲睾賷乇鬲 丕賱賲毓胤賷丕鬲 赖賱 鬲乇賷丿 丕賱鬲爻噩賷賱 ?",
		bYes: "賳毓賲",
		bNo: "賱丕",
		bExit: "廿賱睾丕亍",
		msg: {
	...
	nav : {
		...
		viewtext: "",
		viewtitle: "廿馗赖丕乇 丕賱爻胤乇 丕賱賲禺鬲丕乇"
	},
	col : {
		caption: "廿馗赖丕乇/廿禺賮丕亍 丕賱兀毓賲丿丞",
		bSubmit: "鬲孬亘賷孬",
		bCancel: "廿賱睾丕亍"
	},
	errors : {
