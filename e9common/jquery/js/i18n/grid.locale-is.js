...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Leita",
	    Reset: "Endursetja",
	    odata : ['sama og', 'ekki sama og', 'minna en', 'minna e冒a jafnt og','st忙rra en','st忙rra e冒a jafnt og', 'byrjar 谩','byrjar ekki 谩','er 铆','er ekki 铆','endar 谩','endar ekki 谩','inniheldur','inniheldur ekki'],
