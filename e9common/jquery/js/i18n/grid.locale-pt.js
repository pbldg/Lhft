...
* Tradu锟斤拷o da jqGrid em Portugues por Frederico Carvalho, http://www.eyeviewdesign.pt
...
$.extend($.jgrid,{
	...
	edit : {
	    ...
	    msg: {
	        ...
	        email: "N锟给 锟?um endere锟给 de email v锟絣ido",
	...
	errors : {
		errcap : "Erro",
		nourl : "N锟给 especificou um url",
		norecords: "N锟给 existem dados para processar",
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "Ter锟絘-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S锟絙ado"
			],
			monthNames: [
				"Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez",
				"Janeiro", "Fevereiro", "Mar锟给", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"
			],
			AmPm : ["am","pm","AM","PM"],
			S: function (j) {return j < 11 || j > 13 ? ['锟?, '锟?, '锟?, '锟?][Math.min((j - 1) % 10, 3)] : '锟?},
			srcformat: 'Y-m-d',
			newformat: 'd/m/Y',
			masks : {
