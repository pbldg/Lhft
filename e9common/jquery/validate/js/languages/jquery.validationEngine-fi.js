        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "*  Kentt盲 on pakollinen",
                ...
                "min": {
                    "regex": "none",
                    "alertText": "* V盲hitt盲isluku on "
                },
                "max": {
                    "regex": "none",
                    "alertText": "* Enimm盲isluku on "
                },
                "past": {
                    "regex": "none",
                    "alertText": "* P盲iv盲m盲盲r盲 ennen "
                },
                "future": {
                    "regex": "none",
                    "alertText": "* P盲iv盲m盲盲r盲 j盲lkeen "
                },	
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "* Enint盲盲n ",
                ...
                "email": {
                    ...
                    "alertText": "* Viallinen s盲hk枚postiosoite"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                ...
                "date": {
                    ...
                    "alertText": "* Viallinen p盲iv盲m盲盲r盲. P盲iv盲m盲盲r盲n  t盲ytyy olla VVVV-KK-PP muodossa"
                },
                "ipv4": {
                ...
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* Erikoismerkit eiv盲t ole sallittuja"
                }
            };
