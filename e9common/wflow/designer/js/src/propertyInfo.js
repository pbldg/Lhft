...
//克隆行的字符串
var wf_param_tr="<tr id='id_tr_wf_checkbox'><td width='20'><input type='checkbox' id='wf_checkbox'/></td><td><input type='text' id='wf_paramName' size='33' onchange='setParam(1)'/></td><td><input type='text' id='wf_paramValue' size='33' onchange='setParam(1)'/></td><td><input type='text' id='wf_paramRemark' size='33' onchange='setParam(1)'/></td></tr>";
var wf_param_o_tr="<tr id='id_tr_wf_o_checkbox'><td width='20'><input type='checkbox' id='wf_o_checkbox'/></td><td><input type='text' id='wf_o_paramName' size='53' onchange='setParam(2)'/></td><td><input type='text' id='wf_o_paramRemark' size='53' onchange='setParam(2)'/></td></tr>";
var wf_param_n_tr="<tr id='id_tr_wf_n_checkbox'><td width='20'><input type='checkbox' id='wf_n_checkbox'/></td><td><input type='text' id='wf_n_paramName' size='53' onchange='setParam(3)'/></td><td><input type='text' id='wf_n_paramRemark' size='53' onchange='setParam(3)'/></td></tr>";
...
function setParam(num){
	...
	str="parent.jsonData_workflow."+s_json+"=jQuery.parseJSON('{}')";
	eval(str);
	$.each($("input[id='"+s_id+"']"),function(id){
		if($(this).val()!=''){
